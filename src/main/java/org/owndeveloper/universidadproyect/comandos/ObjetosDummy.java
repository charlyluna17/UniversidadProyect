...
import org.owndeveloper.universidadproyect.models.*;
...
public class ObjetosDummy {
    public static Aula getAula123(){
        ...
        return new Aula(null, 123, "24 x 36", 50, Pizarron.PIZARRA_ACRILICA);
    }
    ...
    public static Persona getProfesorUno(){
        return new Profesor(null, "Horacio", "Laurin", "22695142",
                new Direccion(), new BigDecimal("25600"));
    }

    public static Persona getProfesorDos(){
        return new Profesor(null, "Ruben", "Gonzalez", "25943608",
                new Direccion(), new BigDecimal("23500"));
    }

    public static Persona getEmpleadoUno(){
        return new Empleado(null, "Lucrecia","Dominguez", "30942108",
                new Direccion(), new BigDecimal("15600"), TipoEmpleado.ADMINISTRATIVO);
    }
    public static Persona getEmpleadoDos(){
        return new Empleado(null, "Roberto", "Lugones", "28902674",
                new Direccion(), new BigDecimal("14250"), TipoEmpleado.MANTENIMIENTO);
    }
}
